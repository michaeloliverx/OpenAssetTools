...
const CommandLineOption* const OPTION_XANIM_FORMAT =
    ...
    .WithDescription("Specifies the format of dumped IW4 XAnim files. Valid values are: XANIM_BIN, GLTF, GLB")
...
bool UnlinkerArgs::SetXAnimDumpingMode() const
{
    ...
    if (specifiedValue == "xanim_bin")
    {
        ObjWriting::Configuration.XAnimOutputFormat = XAnimOutputFormat_e::XANIM_BIN;
        return true;
    }
