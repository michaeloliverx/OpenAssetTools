...
#include "Game/IW3Xenon/XAssets/clipmap_t/clipmap_t_write_db.h"
#include "Game/IW3Xenon/XAssets/comworld/comworld_write_db.h"
#include "Game/IW3Xenon/XAssets/font_s/font_s_write_db.h"
#include "Game/IW3Xenon/XAssets/fxeffectdef/fxeffectdef_write_db.h"
#include "Game/IW3Xenon/XAssets/fximpacttable/fximpacttable_write_db.h"
#include "Game/IW3Xenon/XAssets/gameworldmp/gameworldmp_write_db.h"
#include "Game/IW3Xenon/XAssets/gameworldsp/gameworldsp_write_db.h"
#include "Game/IW3Xenon/XAssets/gfximage/gfximage_write_db.h"
#include "Game/IW3Xenon/XAssets/gfxlightdef/gfxlightdef_write_db.h"
#include "Game/IW3Xenon/XAssets/gfxworld/gfxworld_write_db.h"
#include "Game/IW3Xenon/XAssets/loadedsound/loadedsound_write_db.h"
#include "Game/IW3Xenon/XAssets/localizeentry/localizeentry_write_db.h"
#include "Game/IW3Xenon/XAssets/mapents/mapents_write_db.h"
#include "Game/IW3Xenon/XAssets/material/material_write_db.h"
#include "Game/IW3Xenon/XAssets/materialpixelshader/materialpixelshader_write_db.h"
#include "Game/IW3Xenon/XAssets/materialtechniqueset/materialtechniqueset_write_db.h"
#include "Game/IW3Xenon/XAssets/menudef_t/menudef_t_write_db.h"
#include "Game/IW3Xenon/XAssets/menulist/menulist_write_db.h"
#include "Game/IW3Xenon/XAssets/physpreset/physpreset_write_db.h"
#include "Game/IW3Xenon/XAssets/rawfile/rawfile_write_db.h"
#include "Game/IW3Xenon/XAssets/snd_alias_list_t/snd_alias_list_t_write_db.h"
#include "Game/IW3Xenon/XAssets/sndcurve/sndcurve_write_db.h"
#include "Game/IW3Xenon/XAssets/snddriverglobals/snddriverglobals_write_db.h"
#include "Game/IW3Xenon/XAssets/stringtable/stringtable_write_db.h"
#include "Game/IW3Xenon/XAssets/weapondef/weapondef_write_db.h"
#include "Game/IW3Xenon/XAssets/xanimparts/xanimparts_write_db.h"
#include "Game/IW3Xenon/XAssets/xmodel/xmodel_write_db.h"
...
void ContentWriter::WriteScriptStringList(const bool atStreamStart)
{
    ...
    // Endian swap the ScriptStringList fields in the written buffer
    varScriptStringList->count = endianness::ToBigEndian(varScriptStringList->count);
...
#define SKIP_ASSET(type_index, typeName, headerEntry)                                                                                                          \
    ...
    // Endian swap the XAsset fields (type and header pointer) in the written buffer
    varXAsset->type = static_cast<XAssetType>(endianness::ToBigEndian(static_cast<int>(varXAsset->type)));
    {
        auto headerVal = static_cast<std::uint32_t>(reinterpret_cast<std::uintptr_t>(varXAsset->header.data));
        headerVal = endianness::ToBigEndian(headerVal);
        varXAsset->header.data = reinterpret_cast<void*>(static_cast<std::uintptr_t>(headerVal));
    }
...
void ContentWriter::WriteContent(IZoneOutputStream& stream)
{
    ...
    // Endian swap the XAssetList fields in the written buffer
    varXAssetList->assetCount = endianness::ToBigEndian(varXAssetList->assetCount);
