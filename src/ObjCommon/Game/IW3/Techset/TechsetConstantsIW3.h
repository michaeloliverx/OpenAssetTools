    ...
    static inline state_map::StateMapLayoutVars stateMapVarLayout({
        ...
        {"mtlStencilFuncBack",
         1, {
             ...
             {"Greater", static_cast<size_t>(GFXS_STENCILFUNC_GREATER) << GFXS1_STENCIL_BACK_FUNC_SHIFT},
             {"NotEqual", static_cast<size_t>(GFXS_STENCILFUNC_NOTEQUAL) << GFXS1_STENCIL_BACK_FUNC_SHIFT},
             {"GreaterEqual", static_cast<size_t>(GFXS_STENCILFUNC_GREATEREQUAL) << GFXS1_STENCIL_BACK_FUNC_SHIFT},
             {"Always", static_cast<size_t>(GFXS_STENCILFUNC_ALWAYS) << GFXS1_STENCIL_BACK_FUNC_SHIFT},
