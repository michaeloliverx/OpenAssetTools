...
TEST_CASE("TechsetDumperT4", "[t4][techset][dumper]")
{
...
// TECHNIQUE FLAGS: 0x10
{
  ...
  vertex.texcoord[2] = code.tangent;
    ...
    SECTION("Can dump shader binaries")
    {
        dumper.Dump(context);
        ...
        const auto* vertexShaderFile = mockOutput.GetMockedFile(shader::GetFileNameForVertexShaderAssetName("simple.hlsl"));
        ...
        const auto* pixelShaderFile = mockOutput.GetMockedFile(shader::GetFileNameForPixelShaderAssetName("simple.hlsl"));
        REQUIRE(pixelShaderFile);
        CHECK(pixelShaderFile->AsString() == expectedPixelShader);
    }
}
